...
public class User {
    ...
    public User(String displayName, String email, String connection, int avatarId, long createdAt, String departrment) {
        this.displayName = displayName;
        this.email = email;
        this.connection = connection;
        this.avatarId = avatarId;
        this.createdAt = createdAt;
        this.department = departrment;
    }
    ...
    public String getmDepatrment() {
        return department;
    }

    public void setmDepatrment(String mDepatrment)
    {
        this.department = mDepatrment;
    }
