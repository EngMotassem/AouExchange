...
import apps.aouexchange.StudentActivity.Chat.ChatMessages;
import apps.aouexchange.StudentActivity.Chat.ChatMessagesFragment;
...
public class UsersChatAdapter extends RecyclerView.Adapter<UsersChatAdapter.ViewHolderUsers> {
    ...
    public class ViewHolderUsers extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
           ...
           Intent chatIntent = new Intent(mContextViewHolder, ChatMessages.class);
            ...
            chatIntent.putExtra("rec",mUserDisplayName.getText());
